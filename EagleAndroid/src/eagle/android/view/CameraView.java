 ...
 * @version 2010/05/24 : 新規作成
 */
public class CameraView		extends		LooperSurfaceView
									...
									,	AutoFocusCallback
{
	 ...
	 * @version 2010/05/24 : 新規作成
	 */
	public	byte[]	getCurrentPixels( )	{	return	currentPixels;	}
	 ...
	 * @version 2010/05/24 : 新規作成
	 */
	public	Camera	getNativeCamera( )	{	return	camera;	}
   ...
   public static final void decodeYUV420SP(	int[] rgb,
		   									byte[]
   ...
   /**
     ...
     */
    // YUV420 to BMP
    public static final void decodeYUV420SP(short[] rgb565, byte[] yuv420sp,
    										int width, int height,
    										int	srcX, int srcY,
    										int srcW, int srcH,
    										int	sample )
   ...
   /**
     ...
     */
    // YUV420 to BMP
    public static final void decodeYUV420SP(Bitmap rgb, byte[] yuv420sp,
    										int width, int height,
    										int	srcX, int srcY,
    										int srcW, int srcH,
    										int	sample )
