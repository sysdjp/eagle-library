...
public class Graphics
{
	 ...
	 * @version 2009/11/30 : 新規作成
	 */
	private	static	Rect		getSrcRect( int x, int y, int w, int h )
	{
		Rect	r = srcRect;
		r.left		= x;
		r.top		= y;
	 ...
	 * @version 2009/11/30 : 新規作成
	 */
	private	static	Rect		getDstRect( int x, int y, int w, int h )
	{
		Rect	r = dstRect;
		r.left		= x;
		r.top		= y;
