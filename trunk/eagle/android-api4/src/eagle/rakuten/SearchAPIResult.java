...
public class SearchAPIResult
{
    ...
    public  static  SearchAPIResult     createInstance( SearchKey   key )
    {
        try
        {
            ...
            URL url = new URL( "http://api.rakuten.co.jp/rws/3.0/json?" +
            		"developerId=" + key.developerID +
            		"&operation=ItemSearch" +
            		"&version=2010-09-15" +
            		"&keyword=" + URLEncoder.encode( key.keyword, "UTF-8" ) +
                    "&sort=" + URLEncoder.encode( key.sort, "UTF-8" ) +
                    ( key.genreId.length( ) > 0 ? ( "&genreId=" + key.genreId ) : "" ) +
                    "&imageFlag=1" +
                    "&orFlag=" + key.orFlag +
                    "&NGKeyword=" + URLEncoder.encode( key.NGKeyword, "UTF-8" )
                    );
            ...
            Map< String, Map< String, Map< String, Map< String, List< Map< String, Object > > > > > > map =
                ( Map< String, Map< String, Map< String, Map< String, List< Map< String, Object > > > > > > )JSON.decode( is );
